 ...
 * @author Tobito
 */
public class MovimientosPJ2_201212925 extends Thread{
    ...
    public MovimientosPJ2_201212925(JLabel FigFicha, JLabel SigTurno, JButton botongirar, JLabel nombreTurno){
    ...
    public void run(){
        ...
        //-----------------------------Casillas esquinas-------------------------
        if(FigFicha.getX()==567 && ((FigFicha.getY() == 580)||(FigFicha.getY() == 420)||(FigFicha.getY() == 260)||(FigFicha.getY() == 100)) ){
            if(entero == 1){
                for(int w = 0; 80 > w; w++){
